...
private:
    std::unordered_multimap< messages::JointCmd::Type, std::promise< RoFIData::RofiRespPtr > >
            respMap;
...
private:
    std::unordered_multimap< messages::ConnectorCmd::Type, std::promise< RoFIData::RofiRespPtr > >
            respMap;
    std::mutex respMapMutex;
...
public:
    ConnectorData( RoFIData & rofi, int connectorNumber )
            : rofi( rofi )
