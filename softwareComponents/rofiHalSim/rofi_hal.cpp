...
public:
    ...
    Partition getRunningPartition() override {
        throw std::runtime_error( "getRunningPartition not implemented" );
    }

    UpdatePartition initUpdate() override {
        throw std::runtime_error( "initUpdate not implemented" );
    }

    void reboot() override {
        throw std::runtime_error( "reboot not implemented" );
    }
