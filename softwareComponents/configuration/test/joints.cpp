...
TEST_CASE( "sourceToDest and destToSource" ) {
    ...
    SECTION( "Bigger size modRot" ) {
        ...
        CHECK( equals( center( j.sourceToDest() ), { -5, 0, 0, 1 } ) );
        tmp = { ( 360_deg ).rad() };
        CHECK( j.changePositionsBy( tmp ) ); // Normalizes automatically
        CHECK( 0 <= j.positions()[ 0 ] );
        CHECK( fabs( j.positions()[ 0 ] - ( 180_deg ).rad() ) < 0.000001 );
        CHECK( equals( j.sourceToDest(), rotate( M_PI, { 0, 1, 0 } ) * translate( { 5, 0, 0 } ) ) );
        CHECK( equals( j.sourceToDest(), rotate( -M_PI, { 0, 1, 0 } ) * translate( { 5, 0, 0 } ) ) );
...
TEST_CASE( "Modular joint" )
{
    ...
    SECTION( "Unit size" ) {
        ...
        CHECK( equals( j.destToSource(), translate( { -1, 0, 0 } ) ) );
        CHECK( equals( j.sourceToDest(), translate( {  1, 0, 0 } ) ) );
        CHECK( j.changePositionsBy( tmp ) );
        CHECK( j.positions()[ 0 ] < ERR_MARGIN );
        CHECK( equals( j.destToSource(), translate( { -1, 0, 0 } ) ) );
        CHECK( equals( j.sourceToDest(), translate( {  1, 0, 0 } ) ) );
        tmp = { ( 360_deg ).rad() };
        j.setPositions( tmp );
        CHECK( j.positions()[ 0 ] - ( 360_deg ).rad() < ERR_MARGIN );
        CHECK( equals( j.destToSource(), translate( { -1, 0, 0 } ) ) );
        CHECK( equals( j.sourceToDest(), translate( {  1, 0, 0 } ) ) );
        j.normalize();
        CHECK( j.positions()[ 0 ] < ERR_MARGIN );
        ...
        tmp = { ( 720_deg ).rad() };
        j.setPositions( tmp );
        CHECK( j.positions()[ 0 ] - ( 720_deg ).rad() < ERR_MARGIN );
        CHECK( equals( j.destToSource(), translate( { -1, 0, 0 } ) ) );
        CHECK( equals( j.sourceToDest(), translate( {  1, 0, 0 } ) ) );
        j.normalize();
        CHECK( j.positions()[ 0 ] < ERR_MARGIN );
        ...
        tmp = { ( -1080_deg ).rad() };
        j.setPositions( tmp );
        CHECK( j.positions()[ 0 ] - ( -1080_deg ).rad() < ERR_MARGIN );
        CHECK( equals( j.destToSource(), translate( { -1, 0, 0 } ) ) );
        CHECK( equals( j.sourceToDest(), translate( {  1, 0, 0 } ) ) );
        j.normalize();
        CHECK( j.positions()[ 0 ] < ERR_MARGIN );
        ...
        CHECK( fabs( j.positions()[ 0 ] - ( 90_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI_2, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        CHECK( j.changePositionsBy( tmp ) ); // 90 + 90 = 180 mod 360 = 180
        CHECK( fabs( j.positions()[ 0 ] - ( 180_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        tmp = { ( 450_deg ).rad() };
        j.setPositions( tmp );
        CHECK( fabs( j.positions()[ 0 ] - ( 450_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI_2, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        j.normalize();
        CHECK( fabs( j.positions()[ 0 ] - ( 90_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI_2, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        CHECK( j.changePositionsBy( tmp ) ); // 90 + 360 = 540 mod 360 = 180
        CHECK( fabs( j.positions()[ 0 ] - ( 180_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( ( 540_deg ).rad(), { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        tmp = { ( 810_deg ).rad() };
        j.setPositions( tmp );
        CHECK( fabs( j.positions()[ 0 ] - ( 810_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI_2, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        j.normalize();
        CHECK( fabs( j.positions()[ 0 ] - ( 90_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI_2, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        ...
        tmp = { ( 1170_deg ).rad() };
        j.setPositions( tmp );
        CHECK( fabs( j.positions()[ 0 ] - ( 1170_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI_2, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        j.normalize();
        CHECK( fabs( j.positions()[ 0 ] - ( 90_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI_2, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        ...
        tmp = { ( 540_deg ).rad() };
        j.setPositions( tmp );
        CHECK( fabs( j.positions()[ 0 ] - ( 540_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        j.normalize();
        CHECK( fabs( j.positions()[ 0 ] - ( 180_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        ...
        tmp = { ( 900_deg ).rad() };
        j.setPositions( tmp );
        CHECK( fabs( j.positions()[ 0 ] - ( 900_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        j.normalize();
        CHECK( fabs( j.positions()[ 0 ] - ( 180_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        ...
        tmp = { ( 1260_deg ).rad() };
        j.setPositions( tmp );
        CHECK( fabs( j.positions()[ 0 ] - ( 1260_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        j.normalize();
        CHECK( fabs( j.positions()[ 0 ] - ( 180_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( M_PI, { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        ...
        CHECK( equals( j.sourceToDest(), rotate( ( 123_deg ).rad(), { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        CHECK( j.changePositionsBy( tmp ) );
        CHECK( fabs( j.positions()[ 0 ] - ( 246_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( ( 246_deg ).rad(), { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        tmp = { ( 483_deg ).rad() };
        j.setPositions( tmp );
        CHECK( fabs( j.positions()[ 0 ] - ( 483_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( ( 483_deg ).rad(), { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        j.normalize();
        CHECK( fabs( j.positions()[ 0 ] - ( 123_deg ).rad() ) < ERR_MARGIN );
        CHECK( equals( j.sourceToDest(), rotate( ( 483_deg ).rad(), { 1, 0, 0 } ) * translate( { 1, 0, 0 } ) ) );
        tmp = { ( 360_deg ).rad() };
