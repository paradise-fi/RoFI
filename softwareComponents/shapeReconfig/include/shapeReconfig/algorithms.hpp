 ...
 */
std::vector< rofi::configuration::RofiWorld > getDescendantsRotate( 
 ...
 */
std::vector< rofi::configuration::RofiWorld > getDescendantsDisconnect(
...
std::unordered_set< std::pair< int, int >, HashPairIntInt > occupiedRoficoms( 
...
*/ 
std::vector< rofi::configuration::RofiWorld > getDescendantsConnect(
...
std::vector< rofi::configuration::RofiWorld > getDescendants(
    const rofi::configuration::RofiWorld& current, float step ) 
{
 ...
 */
std::vector< rofi::configuration::RofiWorld > getPredecessors( 
 ...
 */
std::vector< size_t > countModShapes( 
