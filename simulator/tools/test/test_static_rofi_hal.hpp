...
static_assert( !std::is_constructible_v< rofi::hal::RoFI::Joint > );
static_assert( std::is_copy_constructible_v< rofi::hal::RoFI::Joint > );
static_assert( std::is_copy_assignable_v< rofi::hal::RoFI::Joint > );
